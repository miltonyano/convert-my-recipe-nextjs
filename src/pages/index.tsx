...
const Main: React.FC = () => {
  ...
  const handlePaste = useCallback(async () => {
    ...
    const recipeInput: HTMLTextAreaElement = document.querySelector('#recipe');
    recipeInput.value = text;
    setDisabled(!recipeInput);
  }, []);
  ...
  const handleSubmit = useCallback(
    ...
    [addToast, router, storedRecipe],
  );

  return (
      <Content>
        <SEO
          title="Convert My Recipe"
          description="Convert My Recipe gives you a simple way to convert the units inside your recipes. Simply paste or type the recipe, select the units and copy the conversion."
        ...
        <MainContentContainer>
          ...
          <Description>
            <p>Convert My Recipe gives you a simple way to convert the units inside your recipes.</p>
            <p>Simply paste or type the recipe inside the box and click NEXT. Then, select the units to be converted and copy the result.</p>
          </Description>
        </MainContentContainer>
        ...
        <UnitContentContainer id="ounce">
          <UnitHeader>
            ...
            <UnitCite>
              {'This article uses material from the Wikipedia article '}
              <a
                href="https://en.wikipedia.org/wiki/Ounce"
                target="_blank"
                rel="noopener noreferrer"
              >
                &quot;Ounce&quot;
        ...
        <UnitContentContainer id="cup">
          <UnitHeader>
            ...
            <UnitCite>
              {'This article uses material from the Wikipedia article '}
              <a
                href="https://en.wikipedia.org/wiki/Cup_(unit)"
                target="_blank"
                rel="noopener noreferrer"
              >
                &quot;Cup (unit)&quot;
